...
public class MultiThreadDownload extends Thread {
    ...
    public void startDownload() throws IOException {
        ...
        if (conn.getResponseCode() == 200) {
            ...
            //2.创建并设置同等大小的临时文件
            RandomAccessFile raf = new RandomAccessFile(Environment.getExternalStorageDirectory().getPath() + File.separator + getFileName(), "rwd");
        ...
        public void run() {
            ...
            try {
                ...
                if (conn.getResponseCode() == 206) {
                    ...
                    String filePath = Environment.getExternalStorageDirectory().getPath() + File.separator + getFileName();
